                        ...
                        Ext.create('Ext.grid.plugin.CellEditing', {
                            ...
                            listeners: {
                                'beforeedit': function (editor, c, e) {
                                    Ext.getCmp('hkgrid').getSelectionModel().setLocked(true);
                                },
                                'edit': function (editor, c, e) {
                                    Ext.getCmp('hkgrid').getSelectionModel().setLocked(false);
                                    //预存
                                    if (selYdStore.data.length > 0) {
                                        for (var i = 0; i < selYdStore.data.length; i++) {
                                    ...
                                    //查看行是否被选中
                                    if (Ext.getCmp('hkgrid').getSelectionModel().isSelected(c.record)) {
                                            ...
                                            menu: [
                                                {
                                                    text: "导出excel",
                                                    handler: function () {
                                                        if (privilege("财务应付核销_回扣核销_导出")) {
                                                            var sel = Ext.getCmp('hkgrid').getSelectionModel().getSelection();
                                                            if (sel.length == 0) {
                                                            ...
                                                            DownloadFile("CZCLZ.Finance.DownLoadHk", "导出回扣核销.xls", xzlist);
                                                        }
                                                    }
                                                },
                                                {
