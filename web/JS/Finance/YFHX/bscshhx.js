...
function getList(nPage) {
    ...
    CS('CZCLZ.Finance.GetBscShByPage', function (retVal) {
        driverStore.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
...
function getWhxList(nPage) {
    ...
    CS('CZCLZ.Finance.GetSHListByPage', function (retVal) {
                        ...
                        buttons: [
                            {
                                ...
                                iconCls: "save",
                                handler: function () {
                                    if (privilege("财务应付核销_办事处送货核销_核销")) {
                                        var xzlist = [];
                                        ...
                                        CS('CZCLZ.Finance.SaveSHHx', function (retVal) {
                                            if (retVal) {
                                                Ext.Msg.show({
                                                    title: '提示',
                                                    msg: '保存成功!',
                                        ...
                                        menu: [
                                            {
                                                text: "导出excel",
                                                handler: function () {
                                                    if (privilege("财务应付核销_办事处送货核销_导出")) {
                                                        var xzlist = [];
                                                        if (tabN == 1) {
                                                        ...
                                                        DownloadFile("CZCLZ.Finance.DownLoadBscsh", "办事处送货费核销.xls", xzlist);
                                                    }
                                                }
                                            },
                                            {
                    ...
                    dockedItems: [
                        {
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    text: '查询',
                                    handler: function () {
                                        if (privilege("财务应付核销_办事处送货核销_查询")) {
                                            getList(1);
                                        }
                                    }
                                }
