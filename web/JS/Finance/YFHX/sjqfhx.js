...
function getList(nPage) {
    ...
    CS('CZCLZ.Finance.GetQfHxOutByPage', function (retVal) {
        driverStore.setData({
            data: retVal.dt,
            pageSize: pageSize,
            total: retVal.ac,
...
function getWhxList(nPage) {
    ...
    CS('CZCLZ.Finance.GetQfHxOutListByPage', function (retVal) {
                        ...
                        buttons: [
                            {
                                ...
                                handler: function () {
                                    if (privilege("财务应付核销_司机欠付核销_核销")) {
                                        ...
                                        CS('CZCLZ.Finance.SaveQfHxOut', function (retVal) {
                                            if (retVal) {
                                                Ext.Msg.show({
                                                    title: '提示',
                                                    msg: '保存成功!',
                                        ...
                                        menu: [
                                            {
                                                ...
                                                handler: function () {
                                                    if (privilege("财务应付核销_司机欠付核销_导出")) {
                                                        ...
                                                        DownloadFile("CZCLZ.Finance.DownLoadSjqf", "司机欠付核销.xls", xzlist);
                                                    }
                                                }
                                            },
                                            {
