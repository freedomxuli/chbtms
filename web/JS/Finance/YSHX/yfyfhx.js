...
function getYfList(nPage) {
    ...
    CS('CZCLZ.Finance.GetYfyfHxListByPage', function (retVal) {
                                            ...
                                            menu: [
                                                {
                                                    ...
                                                    handler: function () {
                                                        if (privilege("财务应收核销_预付运费核销_导出")) {
                                                            ...
                                                            DownloadFile("CZCLZ.Finance.DownLoadYfyf", "导出预付运费核销.xls", xzlist);
                                                        }
                                                    }
                                                },
                                                {
                                    ...
                                    items: [
                                        {
                                            ...
                                            handler: function () {
                                                if (privilege("财务应收核销_预付运费核销_核销")) {
                                                    ...
                                                    CS('CZCLZ.Finance.SaveYFYFHx', function (retVal) {
                                                        if (retVal) {
                                                            Ext.Msg.show({
                                                                title: '提示',
                                                                msg: '保存成功!',
