...
function delkcfhp(id) {
    if (EditKCFHPStore.data.length > 0) {
        for (var i = 0; i < EditKCFHPStore.data.length; i++) {
            if (EditKCFHPStore.data.items[i].data.yundan_goods_id == id) {
                                            ...
                                            },
                                             {
                                                 ...
                                                 renderer: function (value, cellmeta, record, rowIndex, columnIndex, store) {
                                                     ...
                                                     for (var i = 0; i < KCFHPStore.data.length; i++) {
                                                         if (KCFHPStore.data.items[i].data.yundan_goods_id == record.data.yundan_goods_id) {
                                       ...
                                       items: [
                                           {
                                               ...
                                               handler: function () {
                                                       ...
                                                       CS('CZCLZ.ZCDMag.SaveCF', function (retVal) {
                                                           if (retVal) {
                                                               Ext.Msg.show({
                                                                   title: '提示',
                                                                   msg: '保存成功!',
                                                       ...
                                                       }, CS.onError, cfid, Ext.getCmp("newyundanNum").getValue(), hplist);
